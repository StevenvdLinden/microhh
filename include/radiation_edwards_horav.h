...
#ifndef RADIATON_EDWARDS_HORAV
#define RADIATON_EDWARDS_HORAV
 ...
 */
class Radiation_edwards_horav: public Radiation
{
    public:
        Radiation_edwards_horav(Model*, Input*); ///< Constructor of the radiation class.
        virtual ~Radiation_edwards_horav();      ///< Destructor of the radiation class.
    ...
    private:
        ...
        void calc_radiation_tendency_up(double *, const double *, const double *, double*, double *, double *);
        void calc_radiation_tendency_dn(double *, const double *, const double *, double*, double *, double *);
