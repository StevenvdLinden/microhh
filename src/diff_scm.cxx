...
Diff_scm::Diff_scm(Model* modelin, Input* inputin) : Diff(modelin, inputin)
{
    swdiff = "scm";
    ...
    // Above value for turbulent Prandtl suited for LES, for SCM value of 0.7-1 probably better?
...
#ifndef USECUDA
unsigned long Diff_scm::get_time_limit(const unsigned long idt, const double dt)
{
...
#ifndef USECUDA
double Diff_scm::get_dn(const double dt)
{
...
void Diff_scm::calc_strain2(double* restrict strain2,
...
void Diff_scm::calc_evisc(double* restrict evisc,
...
template <bool resolved_wall>
void Diff_scm::calc_evisc_neutral(double* restrict evisc,
                                     double* restrict u, double* restrict v, double* restrict w,
                                     double* restrict ufluxbot, double* restrict vfluxbot,
...
template <bool resolved_wall>
void Diff_scm::diff_u(double* restrict ut, double* restrict u, double* restrict v, double* restrict w,
...
template <bool resolved_wall>
void Diff_scm::diff_v(double* restrict vt, double* restrict u, double* restrict v, double* restrict w,
                         double* restrict dzi, double* restrict dzhi, double* restrict evisc,
                         double* restrict fluxbot, double* restrict fluxtop,
                         double* restrict rhoref, double* restrict rhorefh)
{
...
void Diff_scm::diff_w(double* restrict wt, double* restrict u, double* restrict v, double* restrict w,
                         double* restrict dzi, double* restrict dzhi, double* restrict evisc,
                         double* restrict rhoref, double* restrict rhorefh)
{
    const int ii = 1;
...
void Diff_scm::diff_c(double* restrict at, double* restrict a,
                         double* restrict dzi, double* restrict dzhi, double* restrict evisc,
                         double* restrict fluxbot, double* restrict fluxtop,
...
double Diff_scm::calc_dnmul(double* restrict evisc, double* restrict dzi, double tPr)
{
    const int jj = grid->icells;
    const int kk = grid->ijcells;
