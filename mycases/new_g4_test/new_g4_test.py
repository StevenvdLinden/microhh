...
with open('new_g4_test.ini') as f:
  for line in f:
...
proffile = open('new_g4_test.prof','w')
proffile.write('{0:^16s} {1:^16s} {2:^16s} {3:^16s} {4:^16s} {5:^16s} {6:^16s} {7:^16s} {8:^16s} {9:^16s}\n'.format('z','th','q_bg','c0','c1','c2','pl0','pl1','fdn_above_0','fdn_above_1'))
for k in range(rowl):
  proffile.write('{0:1.10E} {1:1.10E} {2:1.10E} {3:1.10E} {4:1.10E} {5:1.10E} {6:1.10E} {7:1.10E} {8:1.10E} {9:1.10E}\n'.format(z[k], th[k], q_bg[k], c0[k], c1[k], c2[k], pl0[k], pl1[k], fdn_above_0[k], fdn_above_1[k]))
proffile.close()
